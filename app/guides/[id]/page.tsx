      ...
      <div className="bg-gray-100 min-h-screen py-12 px-6 md:px-12 flex flex-col items-center">
        <div className="relative w-full">
          <div className="absolute inset-0 h-96 w-full overflow-hidden rounded-3xl shadow-xl max-w-full">
            <Image src={guide.bannerImage} alt={`${guide.name} banner`} width={1200} height={320} className="w-full h-full object-cover rounded-3xl" />
            ...
            <div className="flex flex-col md:flex-row gap-12">
              ...
              <div className="md:w-1/2 flex flex-col justify-center text-gray-900">
                ...
                <div className="flex gap-4 mt-8">
                  <button className="w-1/2 bg-button text-white py-3 text-xl rounded-xl font-bold hover:bg-opacity-90 hover:shadow-lg transition">Book Guide</button>
                  <button onClick={() => setSelectedUser({ username: guide.name, img: guide.image })} className="w-1/2 bg-white text-gray-900 py-3 text-xl rounded-xl font-bold border border-gray-300 hover:bg-gray-100 hover:shadow-md transition">Message Guide</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-20 w-full max-w-5xl">
          ...
          {selectedUser ? <Chat/> : <p>Click &quot;Message Guide&quot; to start a conversation.</p>}
        </div>
        <div className="mt-20 w-full max-w-5xl"><Chatbot /></div>
        <div className="mt-20 w-full max-w-5xl"><ReviewForm /></div>
        <div className="mt-20 w-full max-w-5xl"><ReviewList /></div>
      </div>
      <Footer />
    </>
  );
