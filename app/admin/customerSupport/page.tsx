            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <div className="flex flex-col md:flex-row gap-4 mb-6">
                <div className="relative flex-grow">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                ...
                <select
                  ...
                  value={statusFilter}
                  onChange={(e) => setStatusFilter(e.target.value as 'all' | 'open' | 'pending' | 'resolved')}
                >
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <select
                        ...
                        value={statusUpdate}
                        onChange={(e) => setStatusUpdate(e.target.value as 'open' | 'pending' | 'resolved')}
                      >
                        <option value="open">Open</option>
                        <option value="pending">Pending</option>
                        <option value="resolved">Resolved</option>
